...
void assemble_single_line_stokes_matrices(FullMatrix<double> &V_matrix_3_line, FullMatrix<double> &K_matrix_3_line, const BEMProblem<3> &bemmy, bool use_external_quadrature=false,  unsigned int ext_quad_degree=1)
{
...
int main (int argc, char **argv)
{
  ...
  bem_problem_3d_1.singular_quadrature_order=10;
  ...
  assemble_single_line_stokes_matrices(V_matrix_3_line_1,K_matrix_3_line_1,bem_problem_3d_1,true,5);
  ...
  bem_problem_3d_2.singular_quadrature_order=20;
  unsigned int my_quad_order=15;
  ...
  assemble_single_line_stokes_matrices(V_matrix_3_line_2,K_matrix_3_line_2,bem_problem_3d_2,true,my_quad_order);
