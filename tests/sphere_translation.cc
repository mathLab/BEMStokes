...
int main (int argc, char **argv)
{
  ...
  if (std::fabs(bem_problem_3d.rigid_velocities[0]-exact_velocity)/std::fabs(exact_velocity)<=tol)
    std::cout<<"OK rigid translation "<<0<<std::endl;
  else
    std::cout<<"ERROR on rigid translation "<<0<<" : "<<bem_problem_3d.rigid_velocities[0]<<" , "<<exact_velocity<<" , "<<std::fabs(bem_problem_3d.rigid_velocities[0]-exact_velocity)/std::fabs(exact_velocity)<<std::endl;
